    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="font-display text-2xl font-semibold text-ink">{t("admin_quiz_questions_title")}</h1>
          <p className="text-sm text-muted-foreground">
            {t("admin_for")} <Link to="/admin/artifacts/$id" params={{ id: artifactId }} className="underline hover:text-ink">{name}</Link>
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-xl border-2 border-primary/20 bg-primary/5 px-4 py-3 text-sm text-muted-foreground flex items-start gap-3">
        ...
        <div>
          <p className="font-medium text-ink">{t("admin_how_quiz_works")}</p>
          <p className="mt-1">
            {t("admin_quiz_info")}
          </p>
        </div>
      ...
      {autoGeneratedQuestions.length > 0 && (
        <div className="rounded-xl border-2 border-primary/20 bg-card overflow-hidden">
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-display text-base font-semibold text-ink">{t("admin_auto_generated")}</p>
              <p className="text-xs text-muted-foreground">
                {t("admin_auto_gen_desc").replace("{n}", String(autoGeneratedQuestions.length))}
              </p>
            </div>
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            {alreadyImported ? (
                              <span className="text-[10px] font-medium text-jungle">{t("admin_imported")}</span>
                            ) : (
                              <button
                                type="button"
      ...
      {editingId !== null && (
        <div className="rounded-xl border-2 border-primary/30 bg-card p-6 space-y-5 animate-in fade-in slide-in-from-top-2 duration-200">
          <h2 className="font-display text-lg font-semibold text-ink">
            {form.id ? t("admin_edit_question") : t("admin_new_question")}
          </h2>

          {/* Prompt */}
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("admin_question_bm")}</label>
              <textarea
            ...
            <div>
              <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("admin_question_en")}</label>
              <textarea
                ...
                <div key={i} className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-muted-foreground uppercase tracking-wider">
                      {i === form.correct_index ? t("admin_correct") : t("admin_option_n").replace("{n}", String(i + 1))}
                    </span>
          ...
          {/* Difficulty */}
          <div>              <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("admin_difficulty")}</label>
            <select
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              ...
              {saving ? t("admin_saving") : t("admin_save_question")}
            </button>
            <button
              type="button"
              onClick={cancelEdit}
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center gap-4 py-16 text-center">
          ...
          <div>
            <p className="font-display text-lg text-ink">{t("admin_no_questions")}</p>
            <p className="text-sm text-muted-foreground">
              {t("admin_no_questions_desc")}
            </p>
          </div>
          <button
            type="button"
