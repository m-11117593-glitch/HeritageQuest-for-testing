...
export const STRINGS = {
  ...
  delete_account: { bm: "Padam Akaun", en: "Delete Account" },
  delete_account_confirm_title: { bm: "Padam akaun anda?", en: "Delete your account?" },
  delete_account_confirm_desc: { bm: "Tindakan ini akan memadamkan akaun dan semua data anda secara kekal. Ia tidak boleh dibatalkan.", en: "This permanently deletes your account and all your data. It cannot be undone." },
  delete_account_confirm_btn: { bm: "Ya, padam akaun saya", en: "Yes, delete my account" },
  delete_account_deleting: { bm: "Memadam...", en: "Deleting..." },
  delete_account_error: { bm: "Gagal memadam akaun. Sila cuba lagi.", en: "Failed to delete account. Please try again." },
  ...
  auth_forgot_sub: { bm: "Masukkan e-mel anda — kami akan hantar pautan untuk menetapkan semula kata laluan.", en: "Enter your email and we'll send you a link to reset your password." },
  auth_send_reset: { bm: "Hantar Pautan Tetapan Semula", en: "Send Reset Link" },
  auth_reset_email_title: { bm: "📧 Semak e-mel anda", en: "📧 Check your email" },
  auth_reset_sent: { bm: "Kami telah menghantar pautan tetapan semula ke {email}. Sila semak peti masuk (dan folder spam) anda.", en: "We sent a reset link to {email}. Please check your inbox (and spam folder)." },
  auth_reset_title: { bm: "Tetapkan Kata Laluan Baharu", en: "Set a New Password" },
  auth_reset_sub: { bm: "Pilih kata laluan kukuh untuk akaun anda.", en: "Choose a strong password for your account." },
  auth_reset_btn: { bm: "Tetapkan Kata Laluan", en: "Set Password" },
  auth_reset_hint: { bm: "Butang tetapkan dibuka apabila bar kata laluan menjadi hijau dan pengesahan sepadan.", en: "Set password unlocks when the password bar turns green and the confirmation matches." },
  auth_reset_invalid: { bm: "Pautan tetapan semula tidak sah atau telah tamat tempoh. Sila cuba sekali lagi.", en: "This reset link is invalid or has expired. Please try again." },
  auth_back_to_signin: { bm: "Kembali ke log masuk", en: "Back to sign in" },
  auth_onboard_title: { bm: "Siapkan Profil Anda", en: "Set Up Your Profile" },
  auth_onboard_sub: { bm: "Pilih nama pengembara anda dan tetapkan kata laluan untuk akaun Google anda.", en: "Pick your explorer name and set a password for your Google account." },
  auth_onboard_btn: { bm: "Mula Meneroka", en: "Start Exploring" },
  auth_onboard_hint: { bm: "Butang Mula terbuka apabila nama diisi, kata laluan menjadi hijau dan pengesahan sepadan.", en: "Start unlocks when the name is filled, the password bar turns green, and the confirmation matches." },
  // Leaderboard
  ...
  // Admin — artifact add/edit form
  admin_add_new_subtitle: { bm: "Isi butiran di bawah untuk menambah artifak muzium baharu.", en: "Fill in the details below to add a new museum artifact." },
  admin_edit_artifact: { bm: "Sunting Artifak", en: "Edit Artifact" },
  admin_artifact_id: { bm: "ID Artifak", en: "Artifact ID" },
  admin_name_en: { bm: "Nama (EN)", en: "Name (EN)" },
  admin_name_en_placeholder_form: { bm: "Nama dalam Bahasa Inggeris", en: "Name in English" },
  admin_category: { bm: "Kategori", en: "Category" },
  admin_era_en: { bm: "Era (EN)", en: "Era (EN)" },
  admin_era_en_placeholder: { bm: "abad ke-15", en: "15th century" },
  admin_origin_en: { bm: "Asal (EN)", en: "Origin (EN)" },
  admin_origin_en_placeholder: { bm: "Asal dalam Bahasa Inggeris", en: "Origin in English" },
  admin_material_en: { bm: "Bahan (EN)", en: "Material (EN)" },
  admin_material_en_placeholder: { bm: "Bahan dalam Bahasa Inggeris", en: "Material in English" },
  admin_desc_en: { bm: "Penerangan (EN)", en: "Description (EN)" },
  admin_desc_en_placeholder: { bm: "Penerangan panjang dalam Bahasa Inggeris...", en: "Long description in English..." },
  admin_images: { bm: "Gambar", en: "Images" },
  admin_images_hint: { bm: "Muat naik sehingga 3 gambar (JPEG, PNG, atau WebP, maks 5MB setiap satu)", en: "Upload up to 3 images (JPEG, PNG, or WebP, max 5MB each)" },
  admin_image_n: { bm: "Gambar {n}", en: "Image {n}" },
  admin_click_upload: { bm: "Klik untuk muat naik", en: "Click to upload" },
  admin_save_artifact: { bm: "Simpan Artifak", en: "Save Artifact" },
  admin_save_changes: { bm: "Simpan Perubahan", en: "Save Changes" },
  admin_languages: { bm: "Bahasa", en: "Languages" },
  admin_bilingual: { bm: "Kandungan Dwibahasa", en: "Bilingual Content" },
  admin_bilingual_desc: { bm: "Lihat dan sunting kedua-dua Bahasa Melayu dan Inggeris sebelah-menyebelah.", en: "View and edit both Bahasa Melayu and English side by side." },
  admin_auto_translate_hint: { bm: "Isi ruangan EN di atas dan klik untuk terjemah automatik ke BM.", en: "Fill in EN fields above and click to auto-translate to BM." },
  admin_auto_translate_btn: { bm: "Terjemah Automatik ke BM", en: "Auto-translate to BM" },
  admin_translating: { bm: "Menterjemah...", en: "Translating..." },
  admin_translate_done: { bm: "✓ Ruangan BM berjaya diterjemah!", en: "✓ BM fields translated successfully!" },
  admin_validate_bm: { bm: "Sila isi ruangan BM melalui butang Bahasa sebelum menyimpan.", en: "Please fill in BM fields via the Languages button before saving." },
  admin_slug_hint: { bm: "(huruf-kecil-dengan-sempang)", en: "(kebab-case)" },
  admin_auto_from_name: { bm: "auto-dihasilkan-dari-nama", en: "auto-generated-from-name" },
  admin_loading: { bm: "Memuat...", en: "Loading..." },
  // Admin — edit artifact page
  admin_id_label: { bm: "ID:", en: "ID:" },
  admin_edit_subtitle: { bm: "ID: {id}", en: "ID: {id}" },
  admin_updated_success: { bm: "Artifak berjaya dikemas kini!", en: "Artifact updated successfully!" },
  admin_back_to_artifacts: { bm: "Kembali ke artifak", en: "Back to artifacts" },
  admin_delete: { bm: "Padam", en: "Delete" },
  admin_delete_artifact: { bm: "Padam Artifak", en: "Delete Artifact" },
  admin_delete_confirm_desc: { bm: "Tindakan ini tidak boleh dibatalkan.", en: "This action cannot be undone." },
  admin_deleting: { bm: "Memadam...", en: "Deleting..." },
  admin_upload_image: { bm: "Muat naik gambar", en: "Upload image" },
  admin_quizzes: { bm: "Kuiz", en: "Quizzes" },
  // Admin — categories
  admin_categories_count: { bm: "{n} kategori", en: "{n} categories" },
  admin_add_new: { bm: "Tambah Baru", en: "Add New" },
  admin_edit: { bm: "Sunting", en: "Edit" },
  admin_no_categories: { bm: "Belum Ada Kategori", en: "No categories yet" },
  admin_no_categories_desc: { bm: "Cipta kategori pertama anda.", en: "Create your first category." },
  admin_add_category: { bm: "Tambah Kategori Baru", en: "Add New Category" },
  admin_add_category_sub: { bm: "Cipta kategori artifak baharu.", en: "Create a new artifact category." },
  admin_id: { bm: "ID", en: "ID" },
  admin_name_bm: { bm: "Nama (BM)", en: "Name (BM)" },
  admin_name_bm_placeholder: { bm: "Nama dalam BM", en: "Name in BM" },
  admin_name_en_placeholder: { bm: "Nama dalam BI", en: "Name in English" },
  admin_icon_emoji: { bm: "Ikon (emoji)", en: "Icon (emoji)" },
  admin_save: { bm: "Simpan", en: "Save" },
  admin_edit_category: { bm: "Sunting Kategori", en: "Edit Category" },
  admin_sort_order: { bm: "Susunan", en: "Sort Order" },
  // Admin — quizzes
  admin_quiz_questions_title: { bm: "Soalan Kuiz", en: "Quiz Questions" },
  admin_for: { bm: "Untuk:", en: "For:" },
  admin_add_question: { bm: "Tambah Soalan", en: "Add Question" },
  admin_how_quiz_works: { bm: "Cara soalan kuiz berfungsi", en: "How quiz questions work" },
  admin_quiz_info: { bm: "Apabila artifak mempunyai soalan tersimpan di sini, pengguna akan melihat ini dan bukannya soalan auto-jana. Jika tiada soalan disimpan, soalan auto-jana lalai akan digunakan.", en: "When an artifact has saved questions here, users will see these instead of the auto-generated ones. If no questions are saved, the default auto-generated questions will be used." },
  admin_auto_generated: { bm: "Auto-Jana Semasa", en: "Currently Auto-Generated" },
  admin_auto_gen_desc: { bm: "{n} soalan ini dipaparkan kepada pengguna apabila tiada soalan tersimpan. Soalan tersimpan akan menggantikannya.", en: "These {n} questions are shown to users when no custom questions are saved. Custom questions override these." },
  admin_import: { bm: "Import", en: "Import" },
  admin_imported: { bm: "Diimport ✓", en: "Imported ✓" },
  admin_new_question: { bm: "Soalan Baru", en: "New Question" },
  admin_edit_question: { bm: "Sunting Soalan", en: "Edit Question" },
  admin_question_bm: { bm: "Soalan (BM)", en: "Question (BM)" },
  admin_question_en: { bm: "Soalan (EN)", en: "Question (EN)" },
  admin_answer_options: { bm: "Pilihan Jawapan", en: "Answer Options" },
  admin_correct: { bm: "✓ Betul", en: "✓ Correct" },
  admin_option_n: { bm: "Pilihan {n}", en: "Option {n}" },
  admin_mark_correct: { bm: "Tanda betul", en: "Mark correct" },
  admin_difficulty: { bm: "Kesukaran", en: "Difficulty" },
  admin_save_question: { bm: "Simpan Soalan", en: "Save Question" },
  admin_no_questions: { bm: "Belum Ada Soalan Tersuai", en: "No custom questions yet" },
  admin_no_questions_desc: { bm: "Pengguna akan melihat soalan auto-jana berdasarkan data artifak.", en: "Users will see auto-generated questions based on the artifact's data." },
  admin_add_first: { bm: "Tambah Soalan Pertama", en: "Add First Question" },
  admin_delete_confirm: { bm: "Padam soalan ini? Tindakan ini tidak boleh dibatalkan.", en: "Delete this question? This cannot be undone." },
} as const;
